      ...
      <main className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-5xl flex  items-center justify-center gap-10 p-10 rounded-lg">
          ...
          <div className="w-full max-w-md space-y-6 bg-white p-8 rounded-lg shadow-lg">
            <h1 className="text-2xl mb-4 font-serif italic text-black text-center">Join Us!</h1>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <input type="checkbox" id="terms" className="border-gray-500" />
              ...
              <div className="text-center text-sm text-gray-500 mt-4">Or sign up with</div>
